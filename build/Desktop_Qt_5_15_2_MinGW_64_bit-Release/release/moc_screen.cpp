...
QT_MOC_LITERAL(4, 20, 21), // "tmpScreenExecuteTasks"
QT_MOC_LITERAL(5, 42, 8) // "taskList"

    },
    "Screen\0showMsg\0\0msg\0tmpScreenExecuteTasks\0"
    "taskList"
};
...
void Screen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Screen::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Screen::showMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Screen::showMsg(QString _t1)
{
