...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::showMsg)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::signalUpdateLightsInfoDataParse)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpClient::showMsg(QString _t1)
{
...
// SIGNAL 1
void MyTcpClient::signalUpdateLightsInfoDataParse(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
